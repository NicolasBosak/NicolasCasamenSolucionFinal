...
namespace NicolasCasamenSolucion.Controllers
{
    public class PromosController : Controller
    {
        private readonly NicolasCasamenSolucionContext _context;

        public PromosController(NicolasCasamenSolucionContext context)
        {
            _context = context;
        }
        ...
        {
            var nicolasCasamenSolucionContext = _context.Promo.Include(p => p.Burger);
            return View(await nicolasCasamenSolucionContext.ToListAsync());
        }
